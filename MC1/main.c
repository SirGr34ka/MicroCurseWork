...
uint16_t      buffer_addr_USART2 = 0;
uint16_t      buffer_addr_USART3 = 0;
...
void USART_Init()
{
	...
	// divider_USART2 = SystemCoreClock / (16 * BAUD) = 72000000 / (16 * 9600) = 468,75
...
int main()
{
	...
	SysTick_Config( SystemCoreClock / 100000000 );                  // SysTick 1 msec interrupts
